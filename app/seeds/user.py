...
def seed_user():
    demo = User(user="Demo", email="demo@aa.io", password="password")
    marnie = User(
        user="marnie", email="marnie@aa.io", password="password"
    )
    bobbie = User(
        user="bobbie", email="bobbie@aa.io", password="password"
    )
